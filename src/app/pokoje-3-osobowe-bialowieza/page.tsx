...
import { BreadcrumbSchema, Pokoje3OsoboweSchema, Pokoje3OsoboweProductSchema } from '@/components/seo';
import { ZoomableGallery } from '@/components/shared/ZoomableImage';

export const metadata: Metadata = {
  title: 'Pokoje 3-osobowe Białowieża - od 150 zł/os | Dwór Bartnika',
  description: 'Pokoje 3-osobowe Białowieża - nocleg dla rodziny w Dworze Bartnika przy Puszczy Białowieskiej. 25m², łazienka, Wi-Fi, TV, śniadanie w cenie. Od 150 zł/os.',
  alternates: {
    canonical: 'https://dworbartnika.pl/pokoje-3-osobowe-bialowieza',
  },
  openGraph: {
    title: 'Pokoje 3-osobowe Białowieża - od 150 zł/os | Dwór Bartnika',
    description: 'Komfortowe pokoje 3-osobowe przy Puszczy Białowieskiej. 25m², śniadanie w cenie. Od 150 zł/os.',
    ...
    images: [
      {
        url: '/images/og/OG_3_osobowe.jpg',
        width: 1200,
        height: 630,
        alt: 'Pokoje 3-osobowe Białowieża - Dwór Bartnika',
      },
    ],
  },
  twitter: {
    ...
    title: 'Pokoje 3-osobowe Białowieża - od 150 zł/os | Dwór Bartnika',
    description: 'Komfortowe pokoje 3-osobowe przy Puszczy Białowieskiej. Od 150 zł/os.',
    images: ['/images/og/OG_3_osobowe.jpg'],
  },
};

// Galeria zdjęć pokoi 3-osobowych (jak na oryginalnej stronie)
const galleryImages = [
  { src: '/images/rooms/2osobowy_17.jpg', alt: 'Przestronny pokój 3-osobowy z łóżkiem podwójnym i pojedynczym w Dworze Bartnika' },
  { src: '/images/rooms/2osobowy_18.jpg', alt: 'Rodzinny pokój trzyosobowy z wygodnymi łóżkami i drewnianym wystrojem' },
  { src: '/images/rooms/2osobowy_31.jpg', alt: 'Komfortowy pokój 3-osobowy z łazienką i widokiem na ogród sensoryczny' },
];
...
const equipment = [
  ...
  'Łóżka pojedyńcze i podwójne',
  'Elektroniczne zamkni w drzwiach',
];


export default function Pokoje3OsobowePage() {
  return (
    <>
      <BreadcrumbSchema items={[
        { name: "Strona główna", url: "https://dworbartnika.pl" },
        { name: "Hotel Białowieża", url: "https://dworbartnika.pl/hotel-bialowieza" },
        { name: "Pokoje 3-osobowe", url: "https://dworbartnika.pl/pokoje-3-osobowe-bialowieza" }
      ]} />
      ...
      <section className="relative h-[60vh] min-h-[350px] md:h-[85vh] md:min-h-[600px]">
        <Image
          ...
          alt="Dwór Bartnika - pokoje 3-osobowe"
          fill
      ...
      <div className="md:hidden">
          ...
          <div className="max-w-sm mx-auto bg-white rounded-2xl shadow-2xl shadow-black/15 border border-stone-200/60 overflow-hidden">
            <div className="border border-primary-400/20 rounded-xl m-2.5 p-5">
              ...
              <p className="text-gray-700 leading-relaxed text-sm text-center">
                Komfortowe pokoje o metrażu <strong className="font-semibold">25 m²</strong> z 
                łazienką wyposażoną w prysznic. Idealne dla rodzin podróżujących 
        ...
        <div className="relative h-[50vh] min-h-[280px]">
          <Image
            src="/images/rooms/2osobowy_17.jpg"
            alt="Pokój 3-osobowy"
            fill
        ...
        <div className="grid grid-cols-2 gap-2 px-4 pb-4">
          <div className="relative h-[140px] rounded-lg overflow-hidden shadow-md">
            <Image
              src="/images/rooms/2osobowy_18.jpg"
              alt="Pokój 3-osobowy - widok 2"
              fill
              className="object-cover"
              sizes="50vw"
            />
          ...
          <div className="relative h-[140px] rounded-lg overflow-hidden shadow-md">
            <Image
              src="/images/rooms/2osobowy_31.jpg"
              alt="Pokój 3-osobowy - widok 3"
              fill
              className="object-cover"
              sizes="50vw"
            />
              ...
              <div className="lg:col-span-3 order-1 lg:order-2">
                ...
                <section className="mb-8">
                  ...
                  <p className="text-[#6a6a6a] text-[17px] font-light leading-relaxed mb-4">
                    <strong className="font-bold">Metraż</strong> : 25 m<sup>2</sup>
                  </p>
